...
import '../../controller/tcu/tcu_consolidada_controller.dart';
import '../../model/bo/tcu/tcu_certidoes.dart';
import '../../model/bo/tcu/tcu.dart';

class TcuConsolidadaView extends StatefulWidget {
  const TcuConsolidadaView({Key? key, required this.listaDeCertidoes}) : super(key: key);

  final List<Tcu> listaDeCertidoes;

  @override
  State<TcuConsolidadaView> createState() => _TcuConsolidadaViewState();
}

class _TcuConsolidadaViewState extends State<TcuConsolidadaView> {
  @override
  ...
  Widget _textWidget({String? titulo,
